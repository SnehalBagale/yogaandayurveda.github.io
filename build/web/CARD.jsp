...
body{
    ...
    background-image: url(clientvid.png); 
        ...
        <div class="container-fluid">
          ...
          <div class="card" style="width: 20rem;">
            <div class="card-body">
              ...
              <a href="<%=link%>" class="bigbtn btn btn-primary" target="_blank">View Video</a>
            </div>
          </div>
          </div>
        </div>
            ...
            <div class="row">       
                      <div align="center"><a href="clientdashboard.jsp" class="btn btn-dark">Dashboard</a>
                  </div>  
	</div>
