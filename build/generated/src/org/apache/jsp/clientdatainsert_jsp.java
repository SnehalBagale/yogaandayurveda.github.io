...
public final class clientdatainsert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try
    {
        ...
        String q = "insert into client (full_name, email, password, mno, ano, panno, ptype, tid, payamount, permananta, currenta) values("+fname+","+email+","+pass+","+mobileno+","+aadhaarno+","+panno+","+paytype+","+transactionid+","+payamount+","+pera+","+cura+")";
        out.print(q);
