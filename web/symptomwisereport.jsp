...
<html>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <title>Yoga | Symptom-wise Report</title>
...
body{
    /*background-color: #cdcdcd;*/
     background-image: url(symrep.jpg); 
...
a:hover{
    ...
    <body> <h1>Symptom Wise Report</h1>
        <form action="symptomwisereport.jsp">
            
            <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-3">
                    <h2>Choose Symptom Name:</h2>
                </div>
            ...
            <div align="center">  <input type="submit" value="submit" class="btn btn-dark"></div><br><br>
        </form>
        <table class="table table-striped">
            <tr>
                <th class="tbhead">Consult Id
                ...
                <th class="tbhead">Doctor Name    
                <th class="tbhead">Prescription
                <th class="tbhead">Status
            </tr>
  <%
  try
    {
...
//          out.println("<td class='tdrow'>"+rs2.getString(3));
        ...
        st2.close();
        con2.close();
        out.print("</table><br><br><h5>TotalCollection&nbsp;Rs/- :  "+amt+"</h5>");
